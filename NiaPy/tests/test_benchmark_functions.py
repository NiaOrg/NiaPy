...
class TestBenchmarkFunctions(TestCase):
	...
	def test_discus(self):
		discus = Utility().get_benchmark('discus')
		fun = discus.function()
		# TODO some test
		self.assertEqual()

	def test_elliptic(self):
		elliptic = Utility.get_benchmark('elliptic')
		fun = elliptic.function()
		# TODO some test
		self.assertEqual()

	def test_expanded_griewank_plus_rosnbrock(self):
		expandedgriewankplusrosenbrock = Utility().get_benchmark('expandedgriewankplusrosenbrock')
		fun = expandedgriewankplusrosenbrock.function()
		# TODO some test
		self.assertEqual()

	def test_expanded_scaffer(self):
		expandedscaffer = Utility().get_benchmark('expandedscaffer')
		fun = expandedscaffer.function()
		# TODO some test
		self.assertEqual()

	def test_hgbat(self):
		hgbat = Utility().get_benchmark('hgbat')
		fun = hgbat.function()
		# TODO some test
		self.assertEqual()

	def test_katsuura(self):
		katsuura = Utility().get_benchmark('katsuura')
		fun = katsuura.function()
		# TODO some test
		self.assertEqual()

	def test_modifiedscwefel(self):
		modifiedscwefel = Utility().get_benchmark('modifiedscwefel')
		fun = modifiedscwefel.function()
		# TODO some test
		self.assertEqual()

	def test_weierstrass(self):
		weierstrass = Utility().get_benchmark('weierstrass')
		fun = weierstrass.function()
		# TODO some test
		self.assertEqual()
