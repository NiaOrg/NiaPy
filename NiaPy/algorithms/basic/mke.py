...
class MonkeyKingEvolutionV1(Algorithm):
	...
	def set_parameters(self, NP=40, F=0.7, R=0.3, C=3, FC=0.5, **ukwargs):
		...
		"""
		Algorithm.set_parameters(self, NP=NP, itype=ukwargs.pop('itype', MkeSolution), InitPopFunc=ukwargs.pop('InitPopFunc', default_individual_init), **ukwargs)
...
class MonkeyKingEvolutionV3(MonkeyKingEvolutionV1):
	...
	def set_parameters(self, **ukwargs):
		...
		"""
		MonkeyKingEvolutionV1.set_parameters(self, itype=ukwargs.pop('itype', None), InitPopFunc=ukwargs.pop('InitPopFunc', default_numpy_init), **ukwargs)
