...
from NiaPy.algorithms.basic.pso import (
...
from NiaPy.algorithms.basic.mke import (
...
from NiaPy.algorithms.basic.hs import (
    HarmonySearch,
    HarmonySearchV1
)
from NiaPy.algorithms.basic.kh import (
    KrillHerdV1,
    KrillHerdV2,
    KrillHerdV3,
    KrillHerdV4,
...
from NiaPy.algorithms.basic.fwa import (
    FireworksAlgorithm,
