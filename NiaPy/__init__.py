...
NiaPyAlgos += [malgos.HybridBatAlgorithm, malgos.SelfAdaptiveDifferentialEvolutionAlgorithm, malgos.DynNPSelfAdaptiveDifferentialEvolutionAlgorithm, malgos.DifferentialEvolutionBestSimulatedAnnealing]
