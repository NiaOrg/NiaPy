...
benchmarks = ['sphere', 'ackley', 'rosenbrock', 'griewank', 'rastrigin',
              'rosenbrock', 'schwefel', 'schwefel221', 'schwefel222', 'whitley', 'alpine1', 'alpine2', 'happyCat', 'ridge', 'chungReynolds', 'csendes', 'pinter', 'qing', 'quintic', 'salomon', 'schumerSteiglitz', 'step', 'step2', 'step3', MyBenchmark()]
