...
class BFOATestCase(AlgorithmTestCase):
    ...
    def test_parameter_type(self):
        parameters = self.algo.type_parameters()
    ...
    def test_custom(self):
        bfoa_custom = self.algo(NP=50, n_chemotactic=100, n_reproduction=4, n_elimination=1, step_size=0.1,
                                seed=self.seed)
        bfoa_customc = self.algo(NP=50, n_chemotactic=100, n_reproduction=4, n_elimination=1, step_size=0.1,
                                 seed=self.seed)
