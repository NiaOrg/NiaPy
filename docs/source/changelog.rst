...
`v2.7.1 <https://github.com/NiaOrg/NiaPy/releases/tag/v2.7.1>`__ - 2026-08-17
-----------------------------------------------------------------------------

\ `Compare with
v2.7.0 <https://github.com/NiaOrg/NiaPy/compare/v2.7.0...v2.7.1>`__\ 

Added
~~~~~

- Add Anarchic Society Optimization (ASO) algorithm
  (`3cf20a5 <https://github.com/NiaOrg/NiaPy/commit/3cf20a57954178a2b9c5cf057aa572ae94f7abef>`__
  by zhukovamaria).

Fixed
~~~~~

- Fix D212/D211/D213 per latest Codacy report
  (`ebc6aed <https://github.com/NiaOrg/NiaPy/commit/ebc6aed86438db2d4de213812da4e066e524b4a7>`__
  by zhukovamaria).
- Fix D203, D212, D200 docstring issues
  (`cba5903 <https://github.com/NiaOrg/NiaPy/commit/cba59037d82654aa00f2a073873df90596482d3f>`__
  by zhukovamaria).
- Fix docstring style consistently (D212/D213/D406/D407)
  (`313a42d <https://github.com/NiaOrg/NiaPy/commit/313a42df09601f065031296fce140a1678c08e6c>`__
  by zhukovamaria).
- Fix last D212 docstring issue
  (`8f6694b <https://github.com/NiaOrg/NiaPy/commit/8f6694b15a07058e08b9ecb455188035b91e4a56>`__
  by zhukovamaria).
- Fix Codacy docstring style issues (D213, D406, D407, D413)
  (`b9558e3 <https://github.com/NiaOrg/NiaPy/commit/b9558e35ddab1452805d30259b590033d8fc62bd>`__
  by zhukovamaria).
- Fix variadics in set_parameters and init
  (`d54e841 <https://github.com/NiaOrg/NiaPy/commit/d54e84116534c26253b2473a1e8c535e11a81535>`__
  by zhukovamaria).
- Fix Codacy errors: matching run_iteration/set_parameters signatures
  (`9bc7947 <https://github.com/NiaOrg/NiaPy/commit/9bc794709d76521633260ed85f4f10c04c6eff7e>`__
  by zhukovamaria).

Removed
~~~~~~~

- Remove scipy dependency, implement euclidean with numpy
  (`ae50a6c <https://github.com/NiaOrg/NiaPy/commit/ae50a6ca4ffbbb1707a60d58435bdd90bfac06a0>`__
  by zhukovamaria).

`v2.7.0 <https://github.com/NiaOrg/NiaPy/releases/tag/v2.7.0>`__ - 2026-02-06
-----------------------------------------------------------------------------

\ `Compare with
v2.6.1 <https://github.com/NiaOrg/NiaPy/compare/v2.6.1...v2.7.0>`__\ 
...
- Add tests, example, and algorithm documentation for MShOA
  (`d5968ef <https://github.com/NiaOrg/NiaPy/commit/d5968ef239a6b556c8c15a0bc67deb8fa098af1e>`__
  by gunbaz).
...
- Fix Codacy style issues for MShOA
  (`812e420 <https://github.com/NiaOrg/NiaPy/commit/812e420b1bd242022769fe23465cc477e2be099a>`__
  by gunbaz).
...
- Remove executable perms from examples/run_all.sh
  (`ae83472 <https://github.com/NiaOrg/NiaPy/commit/ae83472e07db5af7d15c0873c9b8bc4fb7423ca8>`__
  by Benjamin A. Beasley).
- Remove trailing whitespace in MShOA
  (`08a7e84 <https://github.com/NiaOrg/NiaPy/commit/08a7e846a132877934f11e9c4b4f556fe746d0f0>`__
  by gunbaz).
- Remove blank line in test_run_iteration
  (`d21cdbe <https://github.com/NiaOrg/NiaPy/commit/d21cdbe5c508f4013a82ed55426aa9b58c069f85>`__
  by gunbaz).

`v2.6.1 <https://github.com/NiaOrg/NiaPy/releases/tag/v2.6.1>`__ - 2025-11-24
-----------------------------------------------------------------------------

\ `Compare with
v2.6.0 <https://github.com/NiaOrg/NiaPy/compare/v2.6.0...v2.6.1>`__\ 

`v2.6.0 <https://github.com/NiaOrg/NiaPy/releases/tag/v2.6.0>`__ - 2025-11-21
-----------------------------------------------------------------------------

\ `Compare with
v2.5.2 <https://github.com/NiaOrg/NiaPy/compare/v2.5.2...v2.6.0>`__\ 
...
- fix: dependecies and conda build (#720)
  (`2f86304 <https://github.com/NiaOrg/NiaPy/commit/2f86304188d1ce8b4f511f65949711a82ab2bf97>`__
...
`v2.5.2 <https://github.com/NiaOrg/NiaPy/releases/tag/v2.5.2>`__ - 2025-01-06
-----------------------------------------------------------------------------

\ `Compare with
v2.5.1 <https://github.com/NiaOrg/NiaPy/compare/v2.5.1...v2.5.2>`__\ 
...
\ `Compare with
1.0.1 <https://github.com/NiaOrg/NiaPy/compare/1.0.1...2.0.0>`__\ 
...
\ `Compare with first
commit <https://github.com/NiaOrg/NiaPy/compare/cd5a1ff3e1c9f426fde8b40a625abc654c5434c2...1.0.0>`__\ 
...
- add support for all algorithms in Runner. add example usage with test.
  (`95ce127 <https://github.com/NiaOrg/NiaPy/commit/95ce127f5ec54a7c9570f4cc146cf5be4a01b5af>`__
  by GregaVrbancic).
- add support for custom benchmark in runner.
  (`8f058c6 <https://github.com/NiaOrg/NiaPy/commit/8f058c6020c07fa68bbfe170d2583913713f9d23>`__
  by GregaVrbancic).
- add support for DE algorithm
  (`791eb24 <https://github.com/NiaOrg/NiaPy/commit/791eb24699c5d6198be2cb5b5f1ff32a5f739ea4>`__
  by Grega Vrbančič).
...
- add benchmarks module
  ...
  by GregaVrbancic). modified: NiaPy/**init**.py, new file:
  NiaPy/benchmarks/**init**.py, modified: NiaPy/benchmarks/rastrigin.py,
  modified: NiaPy/benchmarks/rosenbrock.py, modified:
  NiaPy/benchmarks/sphere.py
...
`2.7.0 <https://github.com/NiaOrg/NiaPy/releases/tag/2.7.0>`__ - 2026-02-06
---------------------------------------------------------------------------

\ `Compare with
v2.6.1 <https://github.com/NiaOrg/NiaPy/compare/v2.6.1...2.7.0>`__\ 
...
`2.6.1 <https://github.com/NiaOrg/NiaPy/releases/tag/2.6.1>`__ - 2025-11-24
---------------------------------------------------------------------------

\ `Compare with
v2.6.0 <https://github.com/NiaOrg/NiaPy/compare/v2.6.0...2.6.1>`__\ 

.. _v2.6.0---2025-11-21-2:
...
`2.6.0 <https://github.com/NiaOrg/NiaPy/releases/tag/2.6.0>`__ - 2025-11-21
---------------------------------------------------------------------------

\ `Compare with
v2.5.2 <https://github.com/NiaOrg/NiaPy/compare/v2.5.2...2.6.0>`__\ 
...
.. _v2.3.0---2024-05-17-5:

`v2.3.0 <https://github.com/NiaOrg/NiaPy/releases/tag/v2.3.0>`__ - 2024-05-17
-----------------------------------------------------------------------------

.. _v2.2.0---2024-05-17-5:
